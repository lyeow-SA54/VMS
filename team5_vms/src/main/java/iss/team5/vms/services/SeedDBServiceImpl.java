...
public class SeedDBServiceImpl implements SeedDBService {
	...
	public void createInitialData() {
		...
		if(!rms.tableExist()) {
		rms.createRoom(new Room(BookingAvailablity.OPEN,"Projector and computer","Beacon",5));
		rms.createRoom(new Room(BookingAvailablity.OPEN,"Computer","Frontier",8));
		rms.createRoom(new Room(BookingAvailablity.OPEN,"Whiteboard","Jupiter",3));
		rms.createRoom(new Room(BookingAvailablity.OPEN,"Projector","Mercury",10));
		rms.createRoom(new Room(BookingAvailablity.OPEN,"Whiteboard and computer","Venus",6));
		}	
